...
def refresh_wallet_and_prices():
    try:
        ...
        # جلب المحفظة أولاً لمعرفة العملات الموجودة غير المضافة للبوتات
...
<body>
  ...
  <div id="t1" class="tab-pane active">
    ...
    <details class="card" id="b1-coins-card" open>
      ...
      <div style="overflow-x:auto;padding-top:8px"><table id="b1-coins-table"><thead><tr><th>العملة</th><th>السعر</th><th>ربح اليوم</th><th>الصفقات</th><th>دخول</th><th class="manage-ctrl">حذف</th></tr></thead><tbody></tbody></table></div>
    </details>

    <details class="card" open>
      <summary>📂 صفقات Bot 1 المفتوحة (Live PnL & Persistence)</summary>
      <div style="overflow-x:auto;padding-top:8px"><table id="b1-orders"><thead><tr><th>العملة</th><th>الدخول</th><th>الكمية</th><th>Live PnL</th><th>الوقت</th><th class="manage-ctrl">إجراءات</th></tr></thead><tbody></tbody></table></div>
    </details>
  </div>
  ...
  <div id="t2" class="tab-pane">
    ...
    <details class="card" id="b2-coins-card" open>
      ...
      <div style="overflow-x:auto;padding-top:8px"><table id="b2-coins-table"><thead><tr><th>العملة</th><th>السعر</th><th>ربح اليوم</th><th>الصفقات</th><th>دخول</th><th class="manage-ctrl">حذف</th></tr></thead><tbody></tbody></table></div>
    </details>

    <details class="card" open>
      <summary>📂 صفقات Bot 2 المفتوحة (Live PnL & Persistence)</summary>
      <div style="overflow-x:auto;padding-top:8px"><table id="b2-orders"><thead><tr><th>العملة</th><th>الدخول</th><th>الكمية</th><th>Live PnL</th><th>الوقت</th><th class="manage-ctrl">إجراءات</th></tr></thead><tbody></tbody></table></div>
    </details>
  </div>
  ...
  <div id="t3" class="tab-pane">
    ...
    <details class="card" id="b3-coins-card" open>
      ...
      <div style="overflow-x:auto;padding-top:8px"><table id="b3-market-table"><thead><tr><th>العملة</th><th>السعر</th><th>إطلاق بنقرة</th><th class="manage-ctrl">حذف</th></tr></thead><tbody></tbody></table></div>
    </details>

    <details class="card" open>
      <summary>📂 صفقات Bot 3 المفتوحة (Live PnL & Persistence)</summary>
      <div style="overflow-x:auto;padding-top:8px"><table id="b3-orders"><thead><tr><th>العملة</th><th>الدخول</th><th>أعلى سعر</th><th>الكمية</th><th>Live PnL</th><th>الوقت</th><th class="manage-ctrl">إجراءات</th></tr></thead><tbody></tbody></table></div>
    </details>
  </div>
  ...
  <div id="t4" class="tab-pane">
    ...
    <details class="card" id="pending-card" open>
      <summary style="display:flex;justify-content:space-between;align-items:center">
        ...
        <button class="icon-btn manage-ctrl" style="background:#334155;color:#fff;font-size:12px" title="وضع الإدارة" onclick="toggleManage('pending-card')">⚙️</button>
      </summary>
      <div style="overflow-x:auto;padding-top:8px">
  ...
  try{
          ...
          posHtml += `<tr>
            ...
            <td class="manage-ctrl">
              <div style="display:flex;gap:3px">
                <button class="icon-btn" style="background:var(--danger);color:#fff" title="تسييل فوري" onclick="closeSinglePos('${bKey}','${s}', '${p.id}')">🔥</button>
    ...
    (d.open_limit_orders || []).forEach(o => {
      ordHtml += `<tr>
        ...
        <td class="manage-ctrl"><button class="icon-btn" style="background:#dc2626;color:#fff" title="إلغاء الأمر" onclick="cancelLimitOrder('${o.symbol}', '${o.orderId}')">❌</button></td>
      </tr>`;
    });
...
class WebHandler(http.server.BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        if self.path == '/api/data':
            ...
            # قراءة ملف analytics.html المنفصل وتقديمه للعميل
            try:
